...
export const sectionEditors: SectionEditor[] = [
  ...
  },
  {
    ...
    icon: '▦',
    tokens: [
      { var: '--product-bg', type: 'color', default: '#F8F8F8', label: 'Section Background' },
      { var: '--product-card-bg', type: 'color', default: '#ffffff', label: 'Card Background' },
      { var: '--product-card-border', type: 'color', default: '#e5e5e5', label: 'Card Border Color' },
      { var: '--product-card-radius', type: 'range', default: 12, min: 0, max: 32, step: 1, unit: 'px', label: 'Card Radius' },
      { var: '--product-card-padding', type: 'range', default: 12, min: 4, max: 32, step: 1, unit: 'px', label: 'Card Padding' },
      { var: '--product-card-border-width', type: 'range', default: 1, min: 0, max: 4, step: 1, unit: 'px', label: 'Card Border Width' },
      { var: '--product-grid-gap', type: 'range', default: 12, min: 4, max: 32, step: 1, unit: 'px', label: 'Grid Gap' },
      { var: '--product-title-color', type: 'color', default: '#111827', label: 'Title Color' },
      { var: '--product-title-size', type: 'range', default: 13, min: 10, max: 20, step: 1, unit: 'px', label: 'Title Size' },
      { var: '--product-title-weight', type: 'range', default: 500, min: 100, max: 900, step: 100, unit: '', label: 'Title Weight' },
      { var: '--product-price-color', type: 'color', default: '#111827', label: 'Price Color' },
      { var: '--product-price-size', type: 'range', default: 16, min: 12, max: 24, step: 1, unit: 'px', label: 'Price Size' },
      { var: '--product-price-weight', type: 'range', default: 700, min: 100, max: 900, step: 100, unit: '', label: 'Price Weight' },
      { var: '--product-moq-color', type: 'color', default: '#6b7280', label: 'MOQ / Stats Color' },
      { var: '--product-moq-size', type: 'range', default: 11, min: 8, max: 16, step: 1, unit: 'px', label: 'MOQ Size' },
      { var: '--product-badge-bg', type: 'color', default: '#FFF3E0', label: 'Promo Badge BG' },
      { var: '--product-badge-text', type: 'color', default: '#e65100', label: 'Promo Badge Text' },
      { var: '--product-badge-size', type: 'range', default: 10, min: 8, max: 14, step: 1, unit: 'px', label: 'Badge Font Size' },
      { var: '--product-badge-radius', type: 'range', default: 2, min: 0, max: 16, step: 1, unit: 'px', label: 'Badge Radius' },
      { var: '--product-verified-color', type: 'color', default: '#cc9900', label: 'Verified Color' },
      { var: '--product-verified-size', type: 'range', default: 11, min: 8, max: 16, step: 1, unit: 'px', label: 'Verified Size' },
      { var: '--product-supplier-color', type: 'color', default: '#9ca3af', label: 'Supplier Info Color' },
      { var: '--product-supplier-size', type: 'range', default: 10, min: 8, max: 14, step: 1, unit: 'px', label: 'Supplier Size' },
    ],
  },
  {
    id: 'section-footer',
