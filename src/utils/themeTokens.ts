...
export const themeTokenGroups: TokenGroup[] = [
  {
    ...
    collapsed: false,
    tokens: [
      { var: '--color-primary-50', type: 'color', default: '#fffbea' },
      { var: '--color-primary-100', type: 'color', default: '#fff3c4' },
      { var: '--color-primary-200', type: 'color', default: '#ffe88a' },
      { var: '--color-primary-300', type: 'color', default: '#ffd74f' },
      { var: '--color-primary-400', type: 'color', default: '#ffc61a' },
      { var: '--color-primary-500', type: 'color', default: '#cc9900' },
      { var: '--color-primary-600', type: 'color', default: '#b38600' },
      { var: '--color-primary-700', type: 'color', default: '#997300' },
...
export const sectionEditors: SectionEditor[] = [
  {
    ...
    icon: '▔',
    tokens: [
      { var: '--header-bg', type: 'color', default: '#ffffff', label: 'Background' },
      { var: '--header-height', type: 'range', default: 64, min: 40, max: 100, step: 1, unit: 'px', label: 'Height' },
      { var: '--header-border-color', type: 'color', default: '#e5e5e5', label: 'Bottom Border' },
  ...
  },
  {
    ...
    icon: '≡',
    tokens: [
      { var: '--subheader-bg', type: 'color', default: '#ffffff', label: 'Background' },
      { var: '--subheader-border-color', type: 'color', default: '#e5e5e5', label: 'Bottom Border' },
      ...
      { var: '--subheader-text-color', type: 'color', default: '#525252', label: 'Text Color' },
      { var: '--subheader-hover-color', type: 'color', default: '#b38600', label: 'Hover Color' },
      { var: '--subheader-hover-bg', type: 'text', default: 'rgba(255, 255, 255, 0.8)', label: 'Hover Background' },
      { var: '--subheader-active-color', type: 'color', default: '#b38600', label: 'Active Color' },
    ],
  },
  {
    id: 'section-search',
    ...
    icon: '⌕',
    tokens: [
      { var: '--search-bg', type: 'color', default: '#ffffff', label: 'Background' },
  ...
  },
  {
    ...
    tokens: [
      ...
      { var: '--mega-text-color', type: 'color', default: '#374151', label: 'Text Color' },
      ...
      { var: '--mega-heading-color', type: 'color', default: '#111827', label: 'Heading Color' },
      { var: '--mega-body-text', type: 'color', default: '#6b7280', label: 'Body Text' },
      { var: '--mega-link-color', type: 'color', default: '#cc9900', label: 'Link Color' },
      ...
      { var: '--mega-accent-color', type: 'color', default: '#cc9900', label: 'Accent Color' },
      { var: '--mega-accent-bg', type: 'color', default: '#fef3c7', label: 'Accent Background' },
  ...
  },
  {
    ...
    tokens: [
      ...
      { var: '--catpopup-sidebar-bg', type: 'color', default: '#f9fafb', label: 'Sidebar BG' },
      { var: '--catpopup-sidebar-active-bg', type: 'color', default: '#ffffff', label: 'Sidebar Active BG' },
      { var: '--catpopup-sidebar-active-border', type: 'color', default: '#cc9900', label: 'Sidebar Active Border' },
