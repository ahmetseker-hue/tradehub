...
function renderSlide(slide: HeroSideBannerSlide): string {
  return `
    <div class="swiper-slide">
      <a href="${slide.href}" class="hero-side-slide-link group relative block h-[300px] rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm transition-transform duration-200 ease-out">
