 ...
 * Reusable social login buttons (Google, Facebook, Apple, Email) for authentication flows.
 * Each button emits a custom event with the selected provider.
 */
...
export function SocialLoginButtons(): string {
  return `
