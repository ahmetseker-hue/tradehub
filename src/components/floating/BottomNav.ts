      ...
      <div class="grid h-full grid-cols-5 mx-auto">
        ...
        <button type="button" id="bottom-nav-messages" class="inline-flex flex-col items-center justify-center px-1 group" aria-label="Messages, 1 new">
          <div class="relative">
            ...
            <span class="absolute -top-1.5 -right-2 flex items-center justify-center min-w-4 h-4 px-0.5 text-[10px] font-bold text-white bg-red-500 rounded-full">1</span>
          </div>
        ...
        <button type="button" id="bottom-nav-cart" class="inline-flex flex-col items-center justify-center px-1 group" aria-label="Cart, 3 items">
          <div class="relative">
            ...
            <span class="absolute -top-1.5 -right-2 flex items-center justify-center min-w-4 h-4 px-0.5 text-[10px] font-bold text-white bg-red-500 rounded-full">3</span>
          </div>
